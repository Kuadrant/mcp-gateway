...
func (r *MCPVirtualServerReconciler) SetupWithManager(_ context.Context, mgr ctrl.Manager) error {
	...
	return ctrl.NewControllerManagedBy(mgr).
		...
		// re-reconcile all MCPVirtualServers when a new MCPGatewayExtension is created
		// so config is immediately written to the new namespace.
		// updates don't change the namespace set; delete cleanup is a follow-up (#722).
