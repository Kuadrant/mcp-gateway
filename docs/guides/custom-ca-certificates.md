...
When multiple upstream servers share the same CA, configure it once on the MCPGatewayExtension instead of repeating it on each MCPServerRegistration. This reduces duplication and simplifies CA rotation.
