...
func (in *MCPGatewayExtensionSpec) DeepCopyInto(out *MCPGatewayExtensionSpec) {
	*out = *in
	...
	if in.DiscoveryToolsEnabled != nil {
		in, out := &in.DiscoveryToolsEnabled, &out.DiscoveryToolsEnabled
		*out = new(bool)
		**out = **in
	}
	if in.DiscoveryToolThreshold != nil {
		in, out := &in.DiscoveryToolThreshold, &out.DiscoveryToolThreshold
		*out = new(int32)
		**out = **in
	}
}
