...
func (in *EnvoyFilterConfig) DeepCopyInto(out *EnvoyFilterConfig) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new EnvoyFilterConfig.
func (in *EnvoyFilterConfig) DeepCopy() *EnvoyFilterConfig {
	if in == nil {
		return nil
	}
	out := new(EnvoyFilterConfig)
	in.DeepCopyInto(out)
	return out
}
